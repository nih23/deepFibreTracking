...
class TractographyInformation:
    ...
    def __init__(self, model = 'MLP', representation = 'raw', tensormodel = 'dti', stepwidth = 0.25, b_value = 1000, dim = [1,1,1],
        ...
        self.gridSpacing = gridSpacing # spacing is in IJK
